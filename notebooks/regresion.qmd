...
x_reshaped = (master_df[['length', 'car', 'bus','streetcar', 'subway', 'railroad', 'ferry', 'taxi','motorcycle','bicycle', 'walking', 'home']]).values

fe_lag = spreg.Panel_FE_Lag(
    y=y_reshaped, 
    x=x_reshaped,
    name_y=["avg_time"],
    name_x=["road_length", 'car', 'bus','streetcar', 'subway', 'railroad', 'ferry', 'taxi','motorcycle','bicycle', 'walking', 'home'],
    w=wq)
